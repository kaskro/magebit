<div class="container">
    <div id="vue-container" class="row">
        <div id="slider">
            ...
            <div id="signupForm" class="form-container hide">
                <form action="signup" method="post">
                    ...
                    <div class="form-content">
                        <field caption="Name" id="signup-name" name="fullname" type="text" icon="user" error=""></field>
                        <field caption="Email" id="signup-email" name="email" type="email" icon="email" error="" default=""></field>
                        <field caption="Password" id="signup-password" name="password" type="password" icon="password" error=""></field>
                    </div>
        ...
        <div class="col">
            <div id="loginInfo" class="info hide">
